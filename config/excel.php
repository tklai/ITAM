...
return array(
    ...
    'properties' => [
        'creator'        => 'Christian Alliance College',
        'lastModifiedBy' => 'Christian Alliance College',
        'title'          => 'Spreadsheet',
        'description'    => 'Spreadsheet export',
        'subject'        => 'Spreadsheet export',
        'keywords'       => 'Christian Alliance College',
        'category'       => 'Excel',
        'manager'        => 'Christian Alliance College',
        'company'        => 'Christian Alliance College',
    ],
